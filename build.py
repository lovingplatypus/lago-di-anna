...
<div id="fletter"><div class="fpaper">
  ...
  <div class="ftext">
    ...
    <p>Thank you for taking the time to play through these little games I made for you. I know they may not be the most polished games in the world, and I’m sorry I couldn’t make them much nicer. I’m not exactly a game developer after all, but I hope the thought and effort behind them still came through.</p>
    <p>This all started as just the little platypus game. At first, I thought it would simply be something lighthearted and cute for you to play. But as I kept getting to know you better, and as our conversations continued, I wanted to keep adding more. Every new thing you told me about yourself gave me another idea I wanted to include.</p>
    <p>I wanted it to feel personal rather than a collection of random games. Something that could only have been made for you. Everything I included reminded me of something you said, something you liked, or a conversation we shared.</p>
    ...
    <p>Even with all the distance between us, making this website made me feel a little closer to you. It gave me a place to put all the affection that I could not hand to you in person. I wish I could be there to see your reaction while you go through the website, but for now, I hope this served as a reminder that someone far away cares about you, was thinking about you, and listening to what you say.</p>
    <p>Maybe someday down the line I will come back to this website and add even more things: new memories, new jokes, new games, and new parts of your life that I have yet to learn about.</p>
    <p>I hope you enjoyed what I’ve made for you. It may not be perfect, but it was made with more excitement than I would probably like to admit.</p>
